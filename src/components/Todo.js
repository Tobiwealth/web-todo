	...
	return (
		<div className="flex w-full p-10 pt-0 pb-0 justify-center items-center">
			...
			>
			    ...
			    <div className= {darkMode ? todo.completed ? "line-through text-dark-grayish-blue text-center font-josefin-sans text-base font-normal ds:text-2xl":
			    	"text-light-grayish-blue text-center font-josefin-sans font-normal text-base ds:text-2xl"
			    	    : todo.completed ? "line-through text-center font-josefin-sans font-normal text-base ds:text-2xl text-light-grayish-blue" :
			    	        "font-josefin-sans text-center font-normal ds:text-2xl text-base text-very-dark-grayish-bluee"}
			    >{text}</div>
